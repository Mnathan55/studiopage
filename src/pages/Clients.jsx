...
const Clients = () => {
  return (
    <section className="w-full min-h-[100vh] py-16 px-4 md:px-12 bg-[#efeae3] text-center">
      {/* Heading */}
      <h2 className="text-[#ff4500] font-bold text-lg mb-2">Clients</h2>
      ...
      <div className="grid grid-cols-1 gap-6 mt-2">
        <div className="bg-[#efeae3] p-8 rounded-3xl shadow-2xl max-w-5xl mx-auto">
          <img
      ...
      <h3 className="text-[#ff4500] font-semibold text-xl mt-20 mb-6">Clients</h3>
      ...
      <div className="text-center mt-20 mb-10 px-4">
        <h4 className="text-[#ff4500] font-bold text-lg mb-3">Expertise</h4>
